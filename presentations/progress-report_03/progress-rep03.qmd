...
# Running the pipeline {data-background="progress-rep03_files/img/topic-slide.png" transition="fade-in slide-out" transition-speed="slow"}
...
![OpenCPU web browser]("progress-rep03_files/img/opencpubrowser.png"){.fragment fig-align="center" height=50% width=50%}
