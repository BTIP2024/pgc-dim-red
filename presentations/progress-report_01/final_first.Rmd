---
title: "R Team"
author: "Mark Joseph Garrovillas, Leda Celeste Samin, and Tyrone Mariano"
date: "July 26, 2024"
...
## **Shiny Server and OpenCPU Server for Dimensional Reduction Applications with an scRNAseq Bioinformatics Pipeline** {data-background="img/Copy of QC.png" data-background-size="cover"}

# Outline {data-background="img/Copy of QC.png" data-background-size="cover" style="color: black"}
...
## What we want to do {data-background="img/Copy of QC.png" data-background-size="cover" style="color: black"}

-   Leverage the advantage of R and Docker for reproducible research
-   Implement a separation of concerns paradigm
-   Integrate every step of a bioinformatics pipeline to work
    independently on web-based servers

![](img/outline.png){width="374"}

## Project Recap {data-background="img/Copy of QC.png" data-background-size="cover"}
...
# Current Progress {data-background="img/Copy of QC.png" data-background-size="cover"}

------------------------------------------------------------------------

Successful trial runs ![R package developed and deployed via
OpenCPU](img/r_opencpu.png){width="536"}

------------------------------------------------------------------------

R package via Docker ![](img/docker_image.png){width="800"}

------------------------------------------------------------------------

R package via Docker ![](img/docker_container.png){width="800"}

------------------------------------------------------------------------

Deployed trial shiny package: scRNA Analyzer
![](img/shiny.png){width="900"}
...
# Challenges {data-background="img/Copy of QC.png" data-background-size="cover"}
...
# Next week's to-do {data-background="img/Copy of QC.png" data-background-size="cover"}
